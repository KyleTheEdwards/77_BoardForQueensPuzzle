...
public class BoardForQueensPuzzle {
    ...
    public BoardForQueensPuzzle( int ranks) {
      ...
      for(int x = 0; x < filesWithQueens.length; x++) filesWithQueens[x] = -1;
    }
    ...
    public boolean lastIsNg() {
        for(int currentRank = 0; currentRank < lastRankFilled; currentRank++){
          if(filesWithQueens[lastRankFilled] == filesWithQueens[currentRank] || 
            filesWithQueens[currentRank] + (lastRankFilled - currentRank) == filesWithQueens[lastRankFilled] || 
            filesWithQueens[currentRank] - (lastRankFilled - currentRank) == filesWithQueens[lastRankFilled]){
            return true;
          }
        }
    ...
    public boolean accept() {
      ...
      for(int queen1Rank = 0; queen1Rank < lastRankFilled - 2; queen1Rank++){
        for(int queen2Rank = queen1Rank + 1; queen2Rank < lastRankFilled - 1; queen2Rank++){
          if(filesWithQueens[queen1Rank] == filesWithQueens[queen2Rank] || 
            filesWithQueens[queen1Rank] + (queen2Rank - queen1Rank) == filesWithQueens[queen2Rank] || 
            filesWithQueens[queen2Rank] - (queen2Rank - queen1Rank) == filesWithQueens[queen2Rank]){
            return false;
          }
        }
      }
